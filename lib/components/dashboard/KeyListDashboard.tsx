    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <Card className="overflow-hidden border-slate-200/60 shadow-sm">
        <div className="bg-slate-50/50 border-b border-slate-100 px-5 py-3 hidden md:flex items-center gap-4">
          ...
          <div className="w-56 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            Provider & Label
          </div>
          <div className="flex-1 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            Status & Capabilities
          </div>
          <div className="w-24 text-right text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            Created
          </div>
