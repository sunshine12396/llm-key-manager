...
export const KeyRow: React.FC<KeyRowProps> = ({
  ...
  }, [isExpanded, hasModels, keyData.id]);
          ...
          <div className="flex flex-col gap-1 min-w-[120px]">
            {cooldown ? (
              ...
              <div className="flex flex-col items-start gap-1">
                {(() => {
                  const availableCount = Object.values(modelStatuses).filter(
                    (m) => m.state === "AVAILABLE",
                  ).length;
                  ...
                  >
                    ...
                    <div className="w-full">
                      {(() => {
                        ...
                        const nextRetryMs = status?.nextRetryAt
                          ? status.nextRetryAt - now
                          : 0;
                        const retrySoon =
                          nextRetryMs > 0 && nextRetryMs < 3600000;
                        let retryTimeStr = "";
